...
export function FeesTab({ fund }: FeesTabProps) {
  const { fees } = fund;
            ...
            <tbody className="divide-y divide-gray-100">
              <tr>
                ...
                <td className="px-4 py-3 text-right font-medium">
                  {formatExpenseRatio(fees.managementFee)}
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-gray-900">12b-1 Fee</td>
                <td className="px-4 py-3 text-right font-medium">
                  {fees.twelveBOneOne > 0
                    ? formatExpenseRatio(fees.twelveBOneOne)
                    : "None"}
                </td>
              </tr>
              <tr>
                ...
                <td className="px-4 py-3 text-right font-medium">
                  {formatExpenseRatio(fees.otherExpenses)}
                </td>
              </tr>
